    ...
    <section className='bg-white font-PoppinsRegular'>
          <div className='w-11/12 lg:w-9/12 mx-auto py-5 pb-10 bg-white'>
              <div className='relative'>
                ...
                <h1 className='text-base md:text-xl font-PoppinsSemibold tracking-widest text-center my-10 w-fit mx-auto bg-white px-5 capitalize'>browse jobs by categories</h1>
              </div>
